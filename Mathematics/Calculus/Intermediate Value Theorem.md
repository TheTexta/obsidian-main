If a function $f(x)$ is continuous over $[a,b]$ then every function value between $f(a)$ and $f(b)$ must exist *at least once*. remember if not continuous the value could exist $0-\infty$ times
