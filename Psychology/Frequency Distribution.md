A method for graphing the frequencies of a variables over a sample. you can use a [[Histogram]] for numerical [[independent variable|independent variables]] and a [[Bar Graph]] for qualitative.
